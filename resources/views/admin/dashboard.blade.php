...
<body>
    ...
    <div class="content-container">
        ...
        <div class="main-content" id="main-content">
            ...
            <div class="dashboard" style="color: #fff;">
                ...
                <a href="masterlistDashboard" class="card profile">
                    <ion-icon name="people-circle-outline"></ion-icon>
                    <p>MASTERLISTS</p>
                </a>
                <a href="enrollmentDashboard" class="card notification">
                    <ion-icon name="person-add" style="transform: scaleX(-1);"></ion-icon>
                    <p>ENROLL STUDENTS</p>
                </a>
                <a href="userDashboard" class="card profile">
    ...
    <script>
        ...
        setTimeout(function() {
        document.querySelector('.alert.alert-success').classList.add('fade-out');
        setTimeout(function() {
