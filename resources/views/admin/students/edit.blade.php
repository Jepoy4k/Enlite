...
<body>
    ...
    <div class="form-container">
            <h2 class="my-4">Student's Information</h2>
            ...
            <form action="{{ route('students.update', $student->StudentID) }}" method="POST">
                ...
                <div class="form-group">
                    ...
                    <input type="date" name="Birthdate" class="form-control" value="{{ old('Birthdate', date('Y-m-d', strtotime($student->Birthdate))) }}">
                </div>
                <div class="form-group">
                    <label>Contact Number:</label>
                    <input type="text" name="ContactNumber" class="form-control" value="{{ $student->ContactNumber }}">
                </div>
                <div class="form-group">
                    <label>Enrollment Status:</label>
                    <input type="text" name="EnrollmentStatus" class="form-control" value="{{ $student->EnrollmentStatus }}">
                </div>
